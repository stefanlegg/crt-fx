...
export interface Effect {
    ...
    setUniforms(gl: WebGLRenderingContext, program: WebGLProgram, params: Record<string, any>, time: number, resolution: [number, number]): void;
}
...
export type ImageSource = HTMLImageElement | HTMLCanvasElement | ImageBitmap | ImageData | string | File | Blob;
